        ...
        >
            ...
            <div className="w-5/6 px-5 mt-10 mb-10 mt-auto">
                <Steps direction="horizontal" current={currentStep} className="mb-8">
                    <Step title="2011-2012" description="Cursus au Mali" />
                    <Step title="2012-2014" description="Cursus au Mali" />
                    <Step title="2017-2019" description="Cursus en Belgique" />
                    <Step title="2023-2024" description="Cursus en Belgique" />
                </Steps>
